...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2pwms8y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2pwms8y.containers.anotherwebservice.com/
...
```
git clone git@github.com:rrafaa1312/container-2pwms8y.git
cd container-2pwms8y
```
...
```
docker attach container-2pwms8y
```
